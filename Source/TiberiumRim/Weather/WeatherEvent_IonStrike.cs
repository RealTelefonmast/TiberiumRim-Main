...
public class WeatherEvent_IonStrike : WeatherEvent
{
    ...
    {
        UnityEngine.Graphics.DrawMesh(this.boltMesh, this.strikeLoc.ToVector3ShiftedWithAltitude(AltitudeLayer.Weather), Quaternion.identity,  FadedMaterialPool.FadedVersionOf(TRContent.IonLightningMat, LightningBrightness), 0);
    }
